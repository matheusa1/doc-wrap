				...
				visibleHeadingIds.length > 0
					...
					: [
							headings.reduce((current, heading) => {
								if (
									heading.getBoundingClientRect().top <= HEADING_ACTIVE_OFFSET
								) {
									return heading;
								}
